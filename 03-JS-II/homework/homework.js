...
function obtenerMayor(x, y) {
  ...
  if (y > x) return y;
  return x; 
  // return match.max(x,y); [es otro ejemplo]
}
...
function saludo(idioma) {
  ...
  //if (idioma === "mandarin") return "Nia Hao!";
  //if (idioma === "ingles") return "Hello!";
 switch (idioma){
   case "aleman" : return ("Guten Tag!");
   case "mandarin" : return ("Nia Hao!");
...
function esEntero(numero) {
  ...
  // Tu código:
  if (numero === math.flor(numero)) return true;
  else return false;
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí 
  var arrayTabla6 = [];                               // i = index o indice
  for (var i = 0; i < 11; i++){
